        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminInfo = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    openingDays = table.Column<List<string>>(type: "text[]", nullable: false),
                    AccountId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PharmacyId = table.Column<Guid>(type: "uuid", nullable: false),
                    MedicineId = table.Column<Guid>(type: "uuid", nullable: false),
                    CostOfTab = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalNumberOfTab = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PharmacyReviewId = table.Column<Guid>(type: "uuid", nullable: false),
                    PharmacyId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyReviews", x => x.PharmacyReviewId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfTabsToPurchase = table.Column<int>(type: "integer", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    pharmacyMedicinePharmacyId = table.Column<Guid>(type: "uuid", nullable: true),
                    pharmacyMedicineMedicineId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_PharmacyMedicines_pharmacyMedicinePharmacyId_~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_pharmacyMedicinePharmacyId_pharmacyMedicineMe~",
                table: "Prescriptions",
